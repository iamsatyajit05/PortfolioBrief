        ...
        <section id="howitworks" className="max-w-7xl w-full md:w-9/12 mx-auto py-10">
            ...
            <div className="flex flex-col md:flex-row gap-10 justify-center py-10 md:py-20">
                ...
                <div className="w-4/5 sm:w-1/2 mx-auto">
                    <Image width={256} height={256} style={{width: 'auto', marginLeft: 'auto', marginRight: 'auto'}} className="h-64 mx-auto" src="/1.png" alt="My Image" />
                </div>
            </div>
            <div className="flex flex-col-reverse md:flex-row gap-10 justify-center py-10 md:py-20">
                <div className="w-4/5 sm:w-1/2 mx-auto">
                    <Image width={256} height={256} style={{width: 'auto', marginLeft: 'auto', marginRight: 'auto'}} className="h-64 mx-auto" src="/2.jpg" alt="My Image" />
                </div>
                <div className="w-4/5 sm:w-1/2 flex flex-col justify-center text-center md:text-left mx-auto">
            ...
            <div className="flex flex-col md:flex-row gap-10 justify-center py-10 md:py-20">
                ...
                <div className="w-4/5 sm:w-1/2 mx-auto">
                    <Image width={256} height={256} style={{width: 'auto', marginLeft: 'auto', marginRight: 'auto'}} className="h-64 mx-auto" src="/3.jpg" alt="My Image" />
                </div>
            </div>
        </section>
    );
