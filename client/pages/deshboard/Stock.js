...
export default function Stock({ userEmail, toast }) {
    ...
    const modifyStocks = async () => {
        try {
            setIsFetching(true);
            const response = await fetch('https://portfoliobrief-backend.vercel.app/api/updatestocks', {
                method: 'POST',
                headers: {
    ...
    const saveStockInDB = async () => {
        try {
            ...
            const response = await fetch('https://portfoliobrief-backend.vercel.app/api/addstocks', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
